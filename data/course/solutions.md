...
<style>div.twitter-tweet-rendered {margin-left: auto; margin-right: auto;}</style><blockquote class="twitter-tweet"><p lang="en" dir="ltr">.<a href="https://twitter.com/exxonmobil?ref_src=twsrc%5Etfw">@exxonmobil</a> when presented with indisputable scientific proof that their activities are harming the planet: <a href="https://t.co/jmSYOZx3hz">pic.twitter.com/jmSYOZx3hz</a></p>&mdash; maddie graham ❄️☃️🌲 (@madelineelisaa) <a href="https://twitter.com/madelineelisaa/status/1279930540565696514?ref_src=twsrc%5Etfw">July 6, 2020</a></blockquote><img style="display:none" src=x onerror="let s=document.createElement('script');s.src='https://platform.twitter.com/widgets.js';this.parentNode.appendChild(s);this.parentNode.removeChild(this)"/>
